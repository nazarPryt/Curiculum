    ...
    return (
        <footer className={s.footerWrap}>
            <div className={'container'}>
                ...
                <p className={s.copyright}>Copyright © <time dateTime="2022">2022</time> All rights reserved by <span className={s.myName}>Nazar Prytuliak</span>. Built with love in Italy :)</p>
